    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50">
      ...
      <div className="fixed top-20 right-4 z-40 hidden lg:block">
        <div className="relative">
          ...
          <div className="absolute -top-16 -left-48 bg-white rounded-lg shadow-lg p-3 border-2 border-purple-200 animate-float">
          ...
          {/* Mascote */}
          <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-white shadow-xl animate-bounce-gentle">
            <img 
              src="/lovable-uploads/377fee4e-79b3-490d-ba8f-962f650210da.png" 
